...
if __name__ == '__main__':
    ...
    while (1):
        if state==0:
            ...
            select_file.read_matrix('QQQ.yaml')   # Read file 
            nw.demand_list = select_file.demand_node_yaml  #get pickup,delivery,amount
            node_overlay_screen = pg.Surface.copy(begin.screen)
            state =2
            ...
            for i in range(len(t_route)):
                    time.sleep(1.5)
                    begin.screen.blit(node_overlay_screen,(0,0))
